...
public class TestPSS_New {
	static Logger logger = TestUtils.getLogger(TestPSS_New.class);
	...
	public void addRepresentativeForIndividual() {
		...
		selenium.select("id=ClientContact_ContactPhone_ContactPhoneType_Id", "Mobile");
		selenium.type("id=ClientContact_ContactPhone_Phone_Number", TestUtils.getRandomNumber(10));
	...
	public void testPSS_create() throws Exception {
		...
		//selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/div/div/h4");
		//selenium.click("xpath=(//a[contains(text(),'Manage')])[3]");
		selenium.waitForPageToLoad("30000");
		...
		selenium.select("id=Service_ServiceId", "label=One-Time Purchase");// add second service
		...
		selenium.click("css=button[type=\"button\"]");// click "Next" button
		selenium.type("id=NonWaiverAgencySupports", "waiver agency supports");// "Other Supports" section
		...
		selenium.type("id=SupportPerson_SupportPerson", "Anna");// Natural Support section
		...
		/*selenium.click("id=_IdddPlanOfService_SharedPlannings_Edit");// Shared Planning section
		selenium.waitForPageToLoad("30000");
		...
		selenium.click("_IdddPlanOfService_Medication_MedicationManage");// Medications section
		...
		selenium.type("id=PssBackupAndEmergencyPlan_ProviderNotShowUp",
				"provider does not show up");// Back up and Emergency Plans section
		...
		selenium.type("id=PersonalProfile_IntroductionGreatThingsAbout","great things");// Personal Profile section
		...
		selenium.click("id=IdddPssPersonCenteredness_GivenAChoiceOfServices_Id_lookupitems_idddpssyesnonaoptions_-2");// Person Centeredness section
		...
		selenium.type("id=SupportPerson", "support person");// Absent Contributors section
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "Pending Director Review");//verify status in overview section
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]", "Status: Clarification Requested");//verify status in overview section
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "Pending BIDD Review");//verify status in overview section
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "Approved");//verify status in overview section
	...
	public void testPSS_edit() throws Exception {
		...
		selenium.verifyNotification("A revised PSS has been created");//verify notification
		
		selenium.verifyEquals("css=h3 > span", "Status: In Progress");//verify status in title		
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "In Progress");//verify status in overview section
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "Discarded");//verify status in overview section
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("//div[@id='workspace-maincontent']/div/div[3]/div/h4");
		selenium.click("xpath=(//a[contains(text(),'Manage')])[3]");
		...
		selenium.click("//div[@id='workspace-maincontent']/div/div[3]/div/h4");
		selenium.click("xpath=(//a[contains(text(),'Edit')])[4]");// edit completed by section
		selenium.click("id=essentialInformationCompletedBySave");
		selenium.waitForPageToLoad("30000");

		selenium.click("//div[@id='workspace-maincontent']/div/div[4]/div/h4");// open ID/DD Support section
		...
		selenium.click("id=_IdddPlanOfService_PlanOfService_Details");
		selenium.waitForPageToLoad("30000");
		selenium.click("//div[@id='workspace-maincontent']/div/div[6]/div/h4/span[3]");
		...
		selenium.click("id=_IdddPlanOfService_PlanOfService_Details");// return
																		...
																		// page
		selenium.waitForPageToLoad("30000");
		selenium.click("//div[@id='workspace-maincontent']/div/div[6]/div/h4");
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("xpath=(//a[contains(text(),'Edit')])[5]");// edit
																	// communication
		selenium.waitForPageToLoad("30000");
		selenium.type("id=Communication_MethodOfCommunication",
		...
		selenium.click("id=_IdddPlanOfService_PlanOfService_Details");
		selenium.waitForPageToLoad("30000");
		selenium.click("id=_IdddPlanOfService_BackupAndEmergencyPlan_Edit");// edit Back up and Emergency Plans
		selenium.type("id=PssBackupAndEmergencyPlan_ProviderNotShowUp",
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("id=_IdddPlanOfService_LivingArrangements_Edit");// edit family and living arrangements
		selenium.waitForPageToLoad("30000");
		selenium.type("id=FamilyAndCurrentLivingArrangements",
				"family and current living arrangements edit");
		selenium.click("id=familyAndCurrentLivingArrangementsSave");
		selenium.waitForPageToLoad("30000");
		selenium.click("//div[@id='workspace-maincontent']/div/div[11]/div/h4");// employability section
		...
		selenium.click("css=#DataTables_Table_7 > tbody > tr.odd > td.. > a");// click quick view of empolyments
		selenium.runScript("$('a[role=\"button\"] span[class=\"k-icon k-i-close\"]').click()");
		selenium.click("id=_IdddPlanOfService_Employment_Manage");// manage employment
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Quick View");
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("//div[@id='workspace-maincontent']/div/div[15]/div/h4");
		...
		selenium.verifyEquals("css=h3 > span", "Status: Pending Supervisor/QA Review");//verify status in title		
		selenium.click("//div[@id='workspace-maincontent']/div/div[2]/div/h4");
		selenium.verifyEquals("//div[@id='workspace-maincontent']/div/div[2]/div[2]/div/fieldset/div[6]/span", "Pending Supervisor/QA Review");//verify status in overview section
